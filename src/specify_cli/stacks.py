...
APPROVED_STACKS: dict[str, StackProfile] = {
    ...
    "moodle5-plugin": StackProfile(
        ...
        security_evidence=(
            ...
            "Plan documents how uploads are stored and served through the Files API.",
        ),
    ),
    "moodle5-portal": StackProfile(
        ...
        security_controls=(
            ...
            "Apply rate limits and CAPTCHA on public portal forms (registration, support, contact) at the web tier.",
        ),
        security_pitfalls=(
        ...
        security_evidence=(
            ...
            "Deployment notes include rate-limit and CAPTCHA configuration for public portal endpoints.",
        ),
    ),
    "laravel-inertia-react": StackProfile(
        ...
        security_controls=(
            ...
            "Validate every request with Form Request classes and explicit rules; reject unvalidated array hydration.",
